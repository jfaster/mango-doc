...
如果您不使用maven，请手动下载 `mango-1.6.1.jar <http://search.maven.org/remotecontent?filepath=org/jfaster/mango/1.6.1/mango-1.6.1.jar>`_ 和 `mysql-connector-java-5.1.29 <http://search.maven.org/remotecontent?filepath=mysql/mysql-connector-java/5.1.29/mysql-connector-java-5.1.29.jar>`_ ，并将他们放入工程的classpath下。
